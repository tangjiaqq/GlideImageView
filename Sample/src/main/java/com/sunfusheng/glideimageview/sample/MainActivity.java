...
public class MainActivity extends BaseActivity {
  ...
  String url1 =
      "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1497688355699&di=ea69a930b82ce88561c635089995e124&imgtype=0&src=http%3A%2F%2Fcms-bucket.nosdn.127.net%2Ff84e566bcf654b3698363409fbd676ef20161119091503.jpg";
  String url2 = "http://img1.imgtn.bdimg.com/it/u=4027212837,1228313366&fm=23&gp=0.jpg";
  String url3 =
      "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1529402445474&di=b5da3b2f6a466e618e1e32d4dd2bda4d&imgtype=0&src=http%3A%2F%2F2b.zol-img.com.cn%2Fproduct%2F133_500x2000%2F801%2Fce21ke76FRh4A.jpg";
  ...
  public static final String cat_thumbnail =
      "https://raw.githubusercontent.com/sfsheng0322/GlideImageView/master/resources/cat_thumbnail.jpg";
  ...
  public static final String girl_thumbnail =
      "https://raw.githubusercontent.com/sfsheng0322/GlideImageView/master/resources/girl_thumbnail.jpg";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    image11.setOnClickListener(
        v -> startActivity(new Intent(mContext, RecyclerViewActivity.class)));
    draggableView.setOnClickListener(
        v -> startActivity(new Intent(mContext, NineImageViewActivity.class)));
    ...
    image31.setOnClickListener(v -> {
      ...
      ActivityOptionsCompat compat =
          ActivityOptionsCompat.makeSceneTransitionAnimation(MainActivity.this, image31,
              getString(R.string.transitional_image));
    ...
    image32.setOnClickListener(v -> {
      ...
      ActivityOptionsCompat compat =
          ActivityOptionsCompat.makeSceneTransitionAnimation(MainActivity.this, image32,
              getString(R.string.transitional_image));
      ActivityCompat.startActivity(MainActivity.this, intent, compat.toBundle());
    });
  ...
  private void line3() {
    ...
    image32.centerCrop()
        .error(R.mipmap.image_load_err)
        .load(cat, R.color.placeholder, (isComplete, percentage, bytesRead, totalBytes) -> {
          if (isComplete) {
  ...
  private void line4() {
    ...
    image41.setOnClickListener(v -> {
      ...
      ActivityOptionsCompat compat =
          ActivityOptionsCompat.makeSceneTransitionAnimation(MainActivity.this, image41,
              getString(R.string.transitional_image));
      ActivityCompat.startActivity(MainActivity.this, intent, compat.toBundle());
    });
  }
